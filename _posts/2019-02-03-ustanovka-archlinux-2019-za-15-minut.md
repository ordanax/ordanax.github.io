...
- video
---
![Установка Archlinux 2019 за 15 минут](../img/ustanovka-archlinux-2019-za-15-minut.png){:style="float: left;margin-right: 25px;margin-top: 10px;"} В этом видео я показываю быстрое разворачивание системы на своей машине.
...
Если нужен скрипт для установки с UEFI https://github.com/ordanax/arch_install  
