---
layout: post
title: Загрузочная мультифлешка Ventoy с сохранением данных
description: Загрузочная мультифлешка Ventoy с сохранением данных
...
edit: true
---
![Загрузочная мульти флешка Ventoy c сохранением данных](../img/ventoy.png){:style="float: left;margin-right: 25px;margin-top: 10px;"} Ventoy — очень удобная программа для создания мультифлешки. Ее особое преимущество в том, что ее не нужно постоянно перезаписывать. Достаточно закинуть ISO образ как обычный файл, и все — можно грузиться с образа. Таким же образом, если вам образ более не нужен, то вы его просто удаляете как файл.
...
Далее, если у вас есть необходимость в том, чтобы все изменения, которые вы делаете в загруженном образе, были сохранены, то это тоже можно сделать.
...
```
Где Х — это ваш раздел, на который примонтирована флешка. 
