...
В одном из [прошлых уроков](https://ordanax.github.io/kak-perenesti-site-jekyll-na-github) мы зарегистрировались на GitHub, создали в нем репозиторий и перенесли туда наш **сайт на Jekyll**.
