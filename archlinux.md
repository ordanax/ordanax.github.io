...
Использовать Arch Linux не возможно без постоянного обучения и углубленного изучения Linux. Все начинается с установки системы. Вся установка делается через терминал и уже тут начинается ваше обучение. 
